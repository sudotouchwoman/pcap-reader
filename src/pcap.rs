...
pub struct PcapHeader {
    ...
    pub ts_format: TimeFormat,
    pub snapshot_len: u32,
    pub fcs_and_link_type: u32,
}

impl PcapHeader {
    pub fn parse_from<R: io::Read>(reader: &mut R) -> Result<Self, PcapHeaderError> {
        //                         1                   2                   3
    ...
    pub fn link_type(&self) -> u32 {
        self.fcs_and_link_type & 0x07FF_FFFF
    }

    pub fn is_fcs_present(&self) -> bool {
        (self.fcs_and_link_type & (0x1 << 27)) != 0
    }

    pub fn fcs_len(&self) -> u8 {
        ((self.fcs_and_link_type >> 28) & 0xF) as u8
    }
}
...
impl fmt::Display for Frame {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        let offset = ::time::OffsetDateTime::from(self.timestamp);
